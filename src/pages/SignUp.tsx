      ...
      <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-md mb-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className={`w-full py-3 px-4 bg-gray-950 text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-gray-950 focus:ring-offset-2 mb-4 ${
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link to="/signin" className="text-gray-950 hover:underline">
              Sign In
            </Link>
          </p>
        </div>
